...
// cssEscape is unavailable in jsdom; fall back to a manual escape for CSS identifiers.
function cssEscape(s) {
  if (typeof CSS !== 'undefined' && typeof cssEscape === 'function') return cssEscape(s);
