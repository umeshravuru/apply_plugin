...
// React tracks input values via an internal `_valueTracker` and a property
// descriptor on the prototype. Assigning `el.value = x` bypasses the tracker,
// so React's onChange never fires. Calling the native setter via
// the prototype descriptor restores tracking and lets React notice the change.
